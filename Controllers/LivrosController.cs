...
namespace BibliotecaWeb.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("livroId,titulo,autorId,generoId,publicacao,quantiaEstoque")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("livroId,titulo,autorId,generoId,publicacao,quantiaEstoque")] Livro livro)
        {
            if (id != livro.livroId)
            {
                return NotFound();
